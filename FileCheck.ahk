FileCheck(file){
	static dates:={commands:{date:20150902000000,loc:"lib\commands.xml",url:"http://files.maestrith.com/AHK-Studio/commands.xml",type:1},menus:{date:20151002,loc:"lib\menus.xml",url:"http://files.maestrith.com/AHK-Studio/menus.xml",type:2},scilexer:{date:20150606000000,loc:"SciLexer.dll",url:"http://files.maestrith.com/AHK-Studio/SciLexer.dll",type:1},icon:{date:20150914131604,loc:"AHKStudio.ico",url:"http://files.maestrith.com/AHK-Studio/AHKStudio.ico",type:3},Studio:{date:20151018015303,loc:A_MyDocuments "\Autohotkey\Lib\Studio.ahk",url:"https://raw.githubusercontent.com/maestrith/AHK-Studio-Plugins/master/Lib/Studio.ahk",type:1}}
